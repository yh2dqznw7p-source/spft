...
import ru.spft.command.impl.BindCommand;
import ru.spft.command.impl.HelpCommand;
import ru.spft.command.impl.ToggleCommand;
...
public class CommandManager {
    ...
    public static void chat(String message) {
        ...
        if (mc.player != null) mc.player.sendMessage(Text.of("§8[§cSPFT§8] §7" + message), false);
    }
}
